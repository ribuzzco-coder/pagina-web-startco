...
const envSchema = z
  .object({
    ...
    AUTH_RATE_LIMIT_MAX_SIGNUP: z.coerce.number().int().positive().default(10),
    AUTH_RATE_LIMIT_MAX_LOGIN: z.coerce.number().int().positive().default(20),
    AUTH_RATE_LIMIT_MAX_FORGOT_PASSWORD: z.coerce.number().int().positive().default(10),
  })
...
export const env = envSchema.parse({
  ...
  AUTH_RATE_LIMIT_MAX_SIGNUP: process.env.AUTH_RATE_LIMIT_MAX_SIGNUP,
  AUTH_RATE_LIMIT_MAX_LOGIN: process.env.AUTH_RATE_LIMIT_MAX_LOGIN,
  AUTH_RATE_LIMIT_MAX_FORGOT_PASSWORD: process.env.AUTH_RATE_LIMIT_MAX_FORGOT_PASSWORD,
});

export const AUTH_EMAIL_CALLBACK_PATH = env.NEXT_PUBLIC_AUTH_CALLBACK_PATH;
export const AUTH_POST_LOGIN_PATH = env.NEXT_PUBLIC_AUTH_POST_LOGIN_PATH;
export const AUTH_ERROR_PATH = env.NEXT_PUBLIC_AUTH_ERROR_PATH;
