...
export function StageTabs({ packages, ctaHref, ctaLabel }: StageTabsProps) {
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <Card className="grid gap-8 rounded-[24px] p-6 sm:p-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
              <div>
                <PillBadge>Etapa: {active.stage}</PillBadge>
                ...
                <p className="mt-6 text-sm leading-relaxed text-[#98A0B3]">{active.billing}</p>
