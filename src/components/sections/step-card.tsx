...
export function StepCard({ index, title, description, points, outcome }: StepCardProps) {
  return (
    <Card className="relative rounded-[26px] p-6 sm:p-7">
      ...
      <p className="text-sm leading-relaxed text-[#C7CBD6] sm:text-base">{description}</p>
