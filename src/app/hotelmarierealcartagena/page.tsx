...
const marieLinks = {
  whatsapp: "https://wa.me/573001070989",
  reserve: "https://wa.me/573001070989",
  website: "https://hotelmarierealcartagena.com/",
  maps:
    "https://www.google.com/maps?cid=10486813940927496609&g_mp=CiVnb29nbGUubWFwcy5wbGFjZXMudjEuUGxhY2VzLkdldFBsYWNlEAIYASAA&hl=es-419&source=embed",
  phone: "tel:3053419401",
  facebook: "https://www.facebook.com/share/1DqDcGZAFW/",
  instagram:
    "https://www.instagram.com/hotelmariereal?igsh=MW91Z3k5dDM1djNoZA==",
} as const;

const heroImages = [
  "/images/hotel-marie/rotar-1.jpg",
  "/images/hotel-marie/rotar-2.jpg",
  "/images/hotel-marie/rotar-3.jpg",
] as const;

const quickLinks = [
  { label: "Contáctanos", icon: "wa", href: marieLinks.whatsapp },
  { label: "Haz tu reserva", icon: "calendar", href: marieLinks.reserve },
  { label: "Página Web", icon: "web", href: marieLinks.website },
  { label: "Califícanos", icon: "star", href: marieLinks.maps },
  { label: "Recepción", icon: "phone", href: marieLinks.phone },
  { label: "Cómo llegar", icon: "pin", href: marieLinks.maps },
] as const;
...
const rooms = [
  {
    name: "Doble estándar",
    tone: "soft",
    image: "/images/hotel-marie/doble-estandar.webp",
  },
  {
    name: "Doble con balcón",
    tone: "warm",
    image: "/images/hotel-marie/doble-balcon.jpg",
  },
  { name: "Triple", tone: "sun", image: "/images/hotel-marie/triple.jpg" },
  {
    name: "Familiar",
    tone: "sea",
    image: "/images/hotel-marie/familiar.webp",
  },
] as const;

const spaces = [
  { name: "Tours", tone: "events", image: "/images/hotel-marie/tours.jpg" },
  {
    name: "Restaurante",
    tone: "restaurant",
    image: "/images/hotel-marie/restaurante.jpg",
  },
  {
    name: "Ciudad amurallada",
    tone: "terrace",
    image: "/images/hotel-marie/ciudad-amurallada.jpg",
  },
] as const;

const amenities = [
  { label: "Tours", icon: "star" },
  { label: "Restaurante", icon: "cutlery" },
  { label: "Ciudad amurallada", icon: "pin" },
  { label: "WiFi - Internet", icon: "wifi" },
  { label: "Ubicación privilegiada", icon: "pin" },
  { label: "Atención hotelera", icon: "building" },
] as const;

const hotelLogoSrc = "/images/hotel-marie/logo.png";

export const metadata = createPageMetadata({
  title: "Hotel Marie Real Cartagena",
  description:
    "Landing activa para Hotel Marie Real Cartagena. Lista para personalización.",
...
function HotelBrandMark() {
  return (
    <div className="hotel-caribe-brand-mark">
      <Image
        src={hotelLogoSrc}
        alt="Hotel Marie Real Cartagena"
        width={520}
        height={420}
        priority
...
export default function HotelMarieRealCartagenaPage() {
  return (
    <main className="hotel-caribe-page hotel-marie-page -mt-[76px] min-h-[100dvh]">
      ...
      <section className="hotel-caribe-hero">
        ...
        <div className="hotel-caribe-biolink">
          <div className="hotel-caribe-identity-card">
            ...
            <h1>Cartagena</h1>
            <p className="hotel-caribe-nit">RNT 224529</p>

            <div className="hotel-caribe-socials" aria-label="Redes sociales">
              <a href={marieLinks.instagram} aria-label="Instagram" {...externalProps(marieLinks.instagram)}>
                <Icon name="instagram" />
              </a>
              <a href={marieLinks.facebook} aria-label="Facebook" {...externalProps(marieLinks.facebook)}>
                <Icon name="facebook" />
              </a>
            </div>
          </div>
      ...
      <section className="hotel-caribe-contact" id="contacto">
        <div className="hotel-caribe-map" id="ubicacion">
          <iframe
            title="Ubicación Hotel Marie Real Cartagena"
            src="https://www.google.com/maps?q=Hotel%20Marie%20Real%20Cartagena&output=embed"
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
          />
          <a
            className="hotel-caribe-map__label"
            href={marieLinks.maps}
            aria-label="Abrir ubicación en Google Maps"
            {...externalProps(marieLinks.maps)}
          >
            <Icon name="pin" />
        ...
        <div className="hotel-caribe-contact-card">
          ...
          <div>
            <h2>Contáctanos:</h2>
            <p>Reservas: +57 300 107 0989</p>
            <p>Recepción: +57 305 341 9401</p>
            <p>hotelmarierealcartagena.com</p>
          </div>
        </div>
        <div className="hotel-caribe-footer-socials">
          ...
          <a
            href={marieLinks.whatsapp}
            aria-label="WhatsApp"
            className="hotel-caribe-footer-socials__wa"
            {...externalProps(marieLinks.whatsapp)}
          >
            <Icon name="wa" />
          </a>
          <a href={marieLinks.facebook} aria-label="Facebook" {...externalProps(marieLinks.facebook)}>
          ...
          <a href="/" aria-label="Ir a la página principal de RiBuzz">
            <Image
              ...
              width={30}
              height={30}
              className="hotel-marie-ribuzz-mark h-7 w-7 object-contain"
            />
          </a>
        </div>
        <p className="hotel-caribe-footer-name">Hotel Marie Real Cartagena</p>
      </section>

      <a
        className="hotel-caribe-floating-wa"
        href={marieLinks.whatsapp}
        aria-label="Escribir por WhatsApp a Hotel Marie Real Cartagena"
        {...externalProps(marieLinks.whatsapp)}
      >
        <Icon name="wa" />
      </a>
