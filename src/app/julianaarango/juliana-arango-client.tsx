...
export default function JulianaArangoClient() {
  const handleAddContact = () => {
    const blob = new Blob([buildVCard()], { type: "text/vcard;charset=utf-8" });
    const objectUrl = URL.createObjectURL(blob);
    const link = document.createElement("a");
    link.href = objectUrl;
    link.download = "juliana-arango.vcf";
  ...
  return (
    <main className="diana-page -mt-[76px] min-h-[100dvh]">
      <div className="diana-page__planet diana-page__planet--top">
        <Image src="/images/juliana/planet.png" alt="" fill className="object-contain" aria-hidden="true" />
      </div>
        ...
        <article className="diana-card">
          <div className="diana-card__hero">
            ...
            <div className="diana-card__identity">
              <h1>Juliana Arango</h1>
              <p>Estratega comercial</p>
            </div>
          </div>
          ...
          <div className="diana-card__body">
            ...
            <div className="diana-card__actions">
              ...
              <ShareButton
                ...
                text="Conoce la tarjeta digital de Juliana Arango"
                url={PAGE_URL}
