...
const DIANA_URL = "https://ribuzz.com/dianamarulanda";
const phoneDisplay = "312 249 7582";
const phoneRaw = "573122497582";
const websiteLabel = "www.wecomexintl.com";
const websiteHref = "https://www.wecomexintl.com";
const email = "office@wecomexintl.com";
...
export default function DianaMarulandaClient() {
  const handleAddContact = () => {
    const blob = new Blob([buildVCard()], { type: "text/vcard;charset=utf-8" });
    const objectUrl = URL.createObjectURL(blob);
    const link = document.createElement("a");
    link.href = objectUrl;
    link.download = "diana-marulanda.vcf";
          ...
          <div className="diana-card__body">
            ...
            <div className="diana-card__actions">
              ...
              <ShareButton
                ...
                text="Conoce la tarjeta digital de Diana Marulanda"
                url={DIANA_URL}
