...
const covenasLinks = {
  whatsapp:
    "https://api.whatsapp.com/send?phone=573209397701&text=%C2%A1Hola!%20%F0%9F%A4%97%20Me%20gustar%C3%ADa%20realizar%20una%20reservaci%C3%B3n.%20%F0%9F%8C%B4%F0%9F%9B%8F%EF%B8%8F",
  reserve:
...
const heroImages = [
  "/images/hotel-covenas/rotar-1.jpg",
  "/images/hotel-covenas/rotar-2.jpg",
  "/images/hotel-covenas/rotar-3.jpg",
  "/images/hotel-covenas/rotar-4.jpg",
] as const;
...
const rooms = [
  { name: "Estándar", tone: "soft", image: "/images/hotel-covenas/estandar.jpg" },
  { name: "Doble", tone: "warm", image: "/images/hotel-covenas/doble.webp" },
  { name: "Triple", tone: "sun", image: "/images/hotel-covenas/triple.jpg" },
  { name: "Cuádruple", tone: "sea", image: "/images/hotel-covenas/cuadruple.jpg" },
] as const;

const spaces = [
  { name: "Piscinas", tone: "terrace", image: "/images/hotel-covenas/piscinas.jpg" },
  { name: "Restaurantes", tone: "restaurant", image: "/images/hotel-covenas/restaurante.jpg" },
  { name: "Tours", tone: "events", image: "/images/hotel-covenas/tours.jpg" },
] as const;

const amenities = [
  { label: "Piscinas", icon: "pool" },
  { label: "Restaurantes", icon: "cutlery" },
  { label: "Tours", icon: "star" },
  { label: "WiFi - Internet", icon: "wifi" },
  { label: "Acceso a playa", icon: "pin" },
  { label: "Atención hotelera", icon: "building" },
] as const;

const hotelLogoSrc = "/images/hotel-covenas/logo.jpg";

export const metadata = createPageMetadata({
  title: "Hotel Caribe Coveñas",
  description: "Landing activa para Hotel Caribe Coveñas. Lista para personalización.",
...
export default function HotelCaribeCovenasPage() {
  return (
    <main className="hotel-caribe-page hotel-covenas-page -mt-[76px] min-h-[100dvh]">
      ...
      <section className="hotel-caribe-hero">
        ...
        <div className="hotel-caribe-biolink">
          <div className="hotel-caribe-identity-card">
            ...
            <h1>Coveñas</h1>
            <p className="hotel-caribe-nit">RNT 201758</p>

            <div className="hotel-caribe-socials" aria-label="Redes sociales">
              <a href={covenasLinks.instagram} aria-label="Instagram" {...externalProps(covenasLinks.instagram)}>
                <Icon name="instagram" />
              </a>
              <a href={covenasLinks.facebook} aria-label="Facebook" {...externalProps(covenasLinks.facebook)}>
                <Icon name="facebook" />
              </a>
            </div>
          </div>
      ...
      <section className="hotel-caribe-contact" id="contacto">
        <div className="hotel-caribe-map" id="ubicacion">
          <iframe
            title="Ubicación Hotel Caribe Coveñas"
            src="https://www.google.com/maps?q=9.402976,-75.679051&z=17&output=embed"
            loading="lazy"
            referrerPolicy="no-referrer-when-downgrade"
          />
          <a
            className="hotel-caribe-map__label"
            href={covenasLinks.maps}
            aria-label="Abrir ubicación en Google Maps"
            {...externalProps(covenasLinks.maps)}
          >
            <Icon name="pin" />
        ...
        <div className="hotel-caribe-footer-socials">
          ...
          <a
            href={covenasLinks.whatsapp}
            aria-label="WhatsApp"
            className="hotel-caribe-footer-socials__wa"
            {...externalProps(covenasLinks.whatsapp)}
          >
            <Icon name="wa" />
          </a>
          <a href={covenasLinks.facebook} aria-label="Facebook" {...externalProps(covenasLinks.facebook)}>
          ...
          <a href="/" aria-label="Ir a la página principal de RiBuzz">
            <Image
              ...
              width={30}
              height={30}
              className="hotel-covenas-ribuzz-mark h-7 w-7 object-contain"
            />
          </a>
        </div>
        <p className="hotel-caribe-footer-name">Hotel Caribe Coveñas</p>
      </section>

      <a
        className="hotel-caribe-floating-wa"
        href={covenasLinks.whatsapp}
        aria-label="Escribir por WhatsApp a Hotel Caribe Coveñas"
        {...externalProps(covenasLinks.whatsapp)}
      >
        <Icon name="wa" />
      </a>
